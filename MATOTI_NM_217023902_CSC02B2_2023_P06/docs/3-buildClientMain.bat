...
echo This batch file assumes your package structure for your Client is: csc2b.client
...
REM javadoc %JAVAFX_ARGS% -sourcepath %PRAC_SRC% -classpath %PRAC_BIN%;%PRAC_LIB% -use -version -author -d REM %PRAC_DOCS%\%PRAC_JDOC% -subpackages csc2b
